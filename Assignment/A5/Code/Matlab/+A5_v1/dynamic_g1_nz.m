...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(3,1)=1; nzij_pred(3,2)=4;
  nzij_pred(4,1)=1; nzij_pred(4,2)=6;
  nzij_pred(5,1)=3; nzij_pred(5,2)=6;
  ...
  nzij_current(12,1)=1; nzij_current(12,2)=4;
  nzij_current(13,1)=3; nzij_current(13,2)=4;
  nzij_current(14,1)=6; nzij_current(14,2)=4;
  nzij_current(15,1)=4; nzij_current(15,2)=5;
  ...
  nzij_fwrd(4,1)=4; nzij_fwrd(4,2)=2;
  nzij_fwrd(5,1)=5; nzij_fwrd(5,2)=2;
  nzij_fwrd(6,1)=6; nzij_fwrd(6,2)=2;
  nzij_fwrd(7,1)=7; nzij_fwrd(7,2)=7;
end
